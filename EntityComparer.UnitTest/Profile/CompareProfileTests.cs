...
{
    public class CompareProfileTests
    {
        [Fact]
        public void AddProfile()
        {
            ...
            compareConfiguration.AddProfile<CapacityAvailabilityProfile>();
            var comparer = compareConfiguration.CreateComparer();

            var results = comparer.Compare(entities.existingEntities, entities.newEntities).ToArray();
        ...
        public void AddProfiles()
        {
            ...
            var compareConfiguration = new CompareConfiguration();
            compareConfiguration.AddProfiles(typeof(CapacityAvailabilityProfile).Assembly);
            var comparer = compareConfiguration.CreateComparer();
