                        ...
                        foreach (var setValueConfiguration in updateConfiguration.SetValueConfigurations)
                        {
                            if (setValueConfiguration?.DestinationProperty != null)
                            {
                                ...
                                if (alreadyDefinedInSetValue)
                                    yield return new AlreadyDefinedPropertyException(entityType, NameOf<CopyValuesConfiguration>(OperationConfigurationName), NameOf<SetValueConfiguration>(), [setValueConfiguration.DestinationProperty.Name]);
                            }
                        }
                    }
                }
